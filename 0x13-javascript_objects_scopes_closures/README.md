...
<p>At the end of this project, you are expected to be able to <a href="/rltoken/-y6KJaJmv0I7SQokbrRZgg" title="explain to anyone" target="_blank">explain to anyone</a>, <strong>without the help of Google</strong>:</p>
